...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] gayArray = {-3,4-5,2,-4,-56,-90,-2,-5,2,6,8,9,5,4,3,6,8,9,7,90,3,6,8,9,43,34,56,76,34,2,546,78,4};
        //int[] gayArray = {1,5,3,3,8,4,5,6,7,7,7,8,9,23,34,54,34};
